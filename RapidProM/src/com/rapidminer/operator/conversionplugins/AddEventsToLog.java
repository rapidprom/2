...
public class AddEventsToLog extends Operator {
		...
		while (iterator.hasNext()) {
			...
			if (t != null) {
				...
				while (iterator2.hasNext()) {
					...
					else if (nameAttrib.equals(nameEventIDcolumn) && !nameEventIDcolumn.equals("")) {
						// concept:name
					...
					else if (nameAttrib.equals(lifeCycleColumn) && !lifeCycleColumn.equals("")) {
						// lifecycle:transition
						String value = row.getValueAsString(next);
						XAttributeLiteral attribLC = factory.createAttributeLiteral("lifecycle:transition", value, XLifecycleExtension.instance());
						attribMapEvent.put("lifecycle:transition", attribLC);
					}
					else if (nameAttrib.equals(timestampColumn) && !timestampColumn.equals("")) {
						// timestamp
					...
					else if (nameAttrib.equals(resourceColumn) && !resourceColumn.equals("")) {
						// resource
						String value = row.getValueAsString(next);
						XAttributeLiteral attribResource = factory.createAttributeLiteral("org:resource", value, XOrganizationalExtension.instance());
						attribMapEvent.put("org:resource", attribResource);
					}
					else if (nameAttrib.equals(roleColumn) && !roleColumn.equals("")) {
						// role
						String value = row.getValueAsString(next);
						XAttributeLiteral attribRole = factory.createAttributeLiteral("org:role", value, XOrganizationalExtension.instance());
						attribMapEvent.put("org:role", attribRole);
					}
					else if (nameAttrib.equals(groupColumn) && !groupColumn.equals("")) {
						// group
						String value = row.getValueAsString(next);
						XAttributeLiteral attribGroup = factory.createAttributeLiteral("group:resource", value, XOrganizationalExtension.instance());
						attribMapEvent.put("group:resource", attribGroup);
					}
					else {
						if (next.getValueType() == Ontology.DATE || next.getValueType() == Ontology.DATE_TIME) {
							Date dateValue = row.getDateValue(next);
							XAttributeTimestamp attribTimestampEvent = factory.createAttributeTimestamp(nameAttrib, dateValue, XTimeExtension.instance());
	...
	public List<ParameterType> getParameterTypes() {
		...
		ParameterString parameter2 = new ParameterString("", String.class, "Name of Event concept:name column","Event concept:name column");
		...
		ParameterString parameter3 = new ParameterString("", String.class, "Name of lifecycle:transition column","Lifecycle:transition column");
		...
		ParameterString parameter4 = new ParameterString("", String.class, "Name of time:timestamp column","Time:timestamp column");
		...
		ParameterString parameter5 = new ParameterString("", String.class, "Name of org:resource column","Org:resource column");
		ParameterTypeString parameterType5 = new ParameterTypeString(parameter5.getNameParameter(), parameter5.getDescriptionParameter(), parameter5.getDefaultValueParameter());
		parameterTypes.add(parameterType5);
		parameters.add(parameter5);
		
		ParameterString parameter6 = new ParameterString("", String.class, "Name of org:resource column","Org:resource column");
		ParameterTypeString parameterType6 = new ParameterTypeString(parameter6.getNameParameter(), parameter6.getDescriptionParameter(), parameter6.getDefaultValueParameter());
		parameterTypes.add(parameterType6);
		parameters.add(parameter6);
		
		ParameterString parameter7 = new ParameterString("", String.class, "Name of org:role column","Org:role column");
		ParameterTypeString parameterType7 = new ParameterTypeString(parameter7.getNameParameter(), parameter7.getDescriptionParameter(), parameter7.getDefaultValueParameter());
		parameterTypes.add(parameterType7);
		parameters.add(parameter7);
		
		ParameterString parameter8 = new ParameterString("", String.class, "Name of group:resource column","Group:resource column");
		ParameterTypeString parameterType8 = new ParameterTypeString(parameter8.getNameParameter(), parameter8.getDescriptionParameter(), parameter8.getDefaultValueParameter());

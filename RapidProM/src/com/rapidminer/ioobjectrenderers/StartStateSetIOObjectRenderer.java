...
public class StartStateSetIOObjectRenderer extends AbstractRenderer {

	public Component getVisualizationComponent(Object renderable, IOContainer ioContainer) {
		if (renderable instanceof StartStateSetIOObject) {
			StartStateSetIOObject object = (StartStateSetIOObject)  renderable;
	...
	public static JComponent runVisualization(StartStateSet startStateSet, PluginContext pc) {
		CallProm tp = new CallProm();
		List<Object> parameters = new ArrayList<Object>();
		parameters.add(startStateSet);
		JComponent runVisualizationPlugin = tp.runVisualizationPlugin(pc,"x",parameters);
		return runVisualizationPlugin;
	}

	public String getName() {
		return "StartStateSetrenderer";
	}

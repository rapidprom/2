...
public class Utilities {
	...
	public static ProMJGraph getSizedGraph (ProMJGraphPanel promPanel, int desiredWidth, int desiredHeight) {
	...
	public static Component getSizedPanel (Component fullComponent, Component panel, int desiredWidth, int desiredHeight) {
...
//		panel.setMaximumSize(new Dimension(desiredWidth,desiredHeight));
		...
		//JOptionPane.showMessageDialog(null, "Click on OK button when done with laying out the Dotted Chart.");
		// sleep for a while
		try {
			Thread.sleep(3000);
		} catch (InterruptedException e) {
	...
	public static JPanel getSizedPanelBlock (JComponent fullComponent, JPanel panel, int desiredWidth, int desiredHeight) {
//		panel.setSize(new Dimension(desiredWidth,desiredHeight));
